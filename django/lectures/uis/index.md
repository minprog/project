...
We can then access those props using `this.props.PROP_NAME`, where `this` represents the current object. We can then insert this into our HTML using curly braces:

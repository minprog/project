...
1. Wat is **het probleem** (niet de oplossing) dat jouw project gaat oplossen. Wees duidelijk en specifiek. Een paar abstracte voorbeelden:
    ...
    - Dit is een duidelijk beschreven probleem dat een redelijke groep mensen geregeld tegenkomt omdat er geen goed communicatiemiddel is. Dit kan een app goed oplossen.
    - Er is een breed gebrek aan kennis over een bepaald onderwerp. Een interactief spel of verhalende app mist hier.
    - Dit spelconcept bestaat alleen in de echte fysieke wereld. Maar dit is niet bruikbaar in tijden van isolatie, daarom moet dit een app worden.
    - Er is behoefde aan een mobiele applicatie die het leven kan verbeteren.
...
3. In welke setting wordt je project gebruikt? Een paar voorbeelden:
    ...
    - Thuis op je iPhone, horizontal of landscape mode zijn mogelijk.
    - Voornamelijk op reis op je iPhone, alles moet door intuitieve interactie berijkbaar zijn.
...
- Als je een applicatie maakt dat zich richt op gebruikers, zeg een spel, schets dan de gebruikerservaring. In andere woorden, de situatie waar de gebruiker zich in bevindt:

    - Voeg schetsen toe voor hoe het afgemaakte project eruit ziet voor de gebruiker. Als er meerdere views zijn, schets ze dan individueel.
...
- Maak een schets daarvan hoe je database eruit gaat zien, als het opslagen van data cruciaal is voor je applicatie.
